...
mod lib_tests {
    ...
    fn prepare<E: PairingEngine, R: RngCore>(
        ...
        rng: &mut R,
    ) -> (CommitterKey<E>, TableProvingKey<E::Fr>, TableWitness<E::Fr>, Precomputed<E>, E::G1Affine, E::G1Affine) {
        ...
        (ck, table_key, table_witness, precomputed, c_cm.into(), cm.into())
    }
    ...
    fn full_test() {
        ...
        let (ck, table_key, table_witness, precomputed, c_cm, cm) =
